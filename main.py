...
# cv2.imread('poplovok_night1.png', cv2.IMREAD_GRAYSCALE),
# cv2.imread('poplovok_night2.png', cv2.IMREAD_GRAYSCALE),
# cv2.imread('poplovok_night3.png', cv2.IMREAD_GRAYSCALE),
# cv2.imread('poplovok_night4.png', cv2.IMREAD_GRAYSCALE),
...
previous_frame = capture_screen()

# cv2.namedWindow("Minecraft (Live)")
# cv2.namedWindow("Difference (Movement)")
# cv2.namedWindow("Threshold (Filtered)")
...
while True:
    ...
    # # demonstriruem resultat
    # cv2.imshow("Minecraft (Live)", current_frame)
    # cv2.imshow("Difference (Movement)", diff)
    # cv2.imshow("Threshold (Filtered)", masked_frame)
...
# import numpy as np
#
# image = cv2.imread('poplavok3.png')
#
